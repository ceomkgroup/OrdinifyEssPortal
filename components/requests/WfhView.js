        ...
        <div className="mb-4">
          <div className="mb-3">
            ...
            <p className="mt-0.5 text-[12px] text-[var(--muted)]">
              Track pending, approved and cancelled WFH requests
            </p>
          </div>
          <ListFiltersBar
            search={listQuery}
        ...
        {loading || filterBusy ? (
          ...
          <div className="flex min-h-[200px] flex-col items-center justify-center rounded-2xl border border-dashed border-[var(--border)] bg-[var(--panel-soft)] px-4 text-center">
            ...
            <p className="mt-1 max-w-sm text-[12px] text-[var(--muted)]">
              Submit a request when you need to work from home.
            </p>
            <Button
              type="button"
                  ...
                  {filteredRows.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="max-w-[240px] truncate px-3 py-3 text-[var(--muted)]">
                          {row.reason || "—"}
                        </td>
          ...
          <div className="flex-1 space-y-5">
            ...
            <div className="flex gap-2.5 rounded-xl border border-[var(--violet)]/15 bg-[var(--lavender-soft)]/60 px-3.5 py-3">
              ...
              <p className="text-[12px] leading-relaxed text-[var(--muted)]">
                ...
                WFH requests are subject to manager approval. You will be
