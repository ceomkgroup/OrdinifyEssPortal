    ...
    <Card title="Company Settings" className="h-full">
      <div className="grid grid-cols-2 gap-2.5">
        {ROWS.map(({ key, label, icon: Icon }) => (
          <div
            key={key}
            className="min-w-0 rounded-lg border border-[var(--border)] bg-[var(--panel-soft)] px-3 py-2.5"
          >
            <div className="mb-1.5 flex min-w-0 items-center gap-1.5 text-[var(--violet)]">
